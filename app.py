...
smtp_server = 'globaldigitsolutions.com'  # Your SMTP server
smtp_port = 465  # SMTP port
sender_email = 'smtptest@globaldigitsolutions.com'  # Your sender email address
sender_password = 'X;A8m.,kzOon'  # Your email password
